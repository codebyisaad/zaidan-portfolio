export const SITE = {
  ...
  author: {
    firstName: "Zaidan",
    lastName: "Chaudhary",
    fullName: "Zaidan Chaudhary",
    shortName: "Zaidan",
    jobTitle: "Full Stack Developer / AI Engineer",
    twitterHandle: "zaidanch", // without "@"
  },
  location: {
  ...
  now: {
    text: "Currently working fulltime at",
    linkText: "Devsinc",
    linkUrl: "https://devsinc.com",
  },
  intro: {
    html: "Hi, I'm <b>Zaidan Chaudhary</b>, a Senior Software Engineer & AI Engineer with a focus on scalable, cloud-native applications and AI-driven features.",
    cta: "Feel free to reach out to me if you have any project in mind, want to collaborate, or just want to say hello.",
  },
};
